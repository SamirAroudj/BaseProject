...
#include "Utilities/Profiling/TimeMeasurements.h"
...
namespace Utilities
{
	...
	private:
		...
		std::vector<Platform::TimePoint>	mMeasurementStarts;	/// Stores for each TimeMeasurements the most recent measure start time point.
	};
