...
namespace Graphics
{
	...
	public:
		...
		virtual Math::Matrix3x3 computeHPSToNNRayDirWS(const uint32 &viewportheight, const bool addPixelCenterOffset = true) const = 0;
		...
		virtual Math::Matrix4x4 computeWorldSpaceToPixelSpaceMatrix(const uint32 &viewportHeight, const bool considerPixelCenterOffset = true) const = 0;
